...
public class FlutterSoundPlugin implements MethodCallHandler, PluginRegistry.RequestPermissionsResultListener, AudioInterface{ ;
  ...
  public static void registerWith(Registrar registrar) {
   ...
   // May 14, 2019, copied from version 6 of image_picker plugin because of
  ...
  public void onMethodCall(final MethodCall call, final Result result) {
    ...
    switch (call.method) {
      ...
      default:
        ...
        (new MethodResultWrapper(result)).notImplemented();
        break;
    }
  }
  ...
  @Override
  public void startRecorder(int numChannels, int sampleRate, Integer bitRate, int androidEncoder, String path, final Result rawResult) {
...
//          model.setRecordTime(time);
  ...
  @Override
  public void stopRecorder(final Result rawResult) {
     MethodChannel.Result result = new MethodResultWrapper(rawResult);
  ...
  @Override
  public void startPlayer(final String path, final Result rawResult) {
    MethodChannel.Result result = new MethodResultWrapper(rawResult);
  ...
  @Override
  public void stopPlayer(final Result rawResult) {
    MethodChannel.Result result = new MethodResultWrapper(rawResult);
    mTimer.cancel();
  ...
  @Override
  public void pausePlayer(final Result rawResult) {
    MethodChannel.Result result = new MethodResultWrapper(rawResult);
    if (this.model.getMediaPlayer() == null) {
      result.error(ERR_PLAYER_IS_NULL, ERR_PLAYER_IS_NULL, ERR_PLAYER_IS_NULL);
      return;
  ...
  @Override
  public void resumePlayer(final Result rawResult) {
    MethodChannel.Result result = new MethodResultWrapper(rawResult);
    if (this.model.getMediaPlayer() == null) {
      result.error(ERR_PLAYER_IS_NULL, ERR_PLAYER_IS_NULL, ERR_PLAYER_IS_NULL);
      return;
  ...
  @Override
  public void seekToPlayer(int millis, final Result rawResult) {
     MethodChannel.Result result = new MethodResultWrapper(rawResult);
    if (this.model.getMediaPlayer() == null) {
      result.error(ERR_PLAYER_IS_NULL, ERR_PLAYER_IS_NULL, ERR_PLAYER_IS_NULL);
      return;
  ...
  @Override
  public void setVolume(double volume, final Result rawResult) {
    MethodChannel.Result result = new MethodResultWrapper(rawResult);
    if (this.model.getMediaPlayer() == null) {
      result.error(ERR_PLAYER_IS_NULL, ERR_PLAYER_IS_NULL, ERR_PLAYER_IS_NULL);
      return;
  ...
  @Override
  public void setDbPeakLevelUpdate(double intervalInSecs, Result rawResult) {
    MethodChannel.Result result = new MethodResultWrapper(rawResult);
  ...
  @Override
  public void setDbLevelEnabled(boolean enabled, MethodChannel.Result rawResult) {
    MethodChannel.Result result = new MethodResultWrapper(rawResult);
  ...
  @Override
  public void setSubscriptionDuration(double sec, Result rawResult) {
    MethodChannel.Result result = new MethodResultWrapper(rawResult);
